...
class TribunaBern1Spider(scrapy.Spider):
    """
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        ...
        try:
            ...
            strict_flag = False
        spider = super(TribunaBern1Spider, cls).from_crawler(crawler, *args, strict_full=strict_flag, **kwargs)
        try:
