...
class TribunaJuraSpider(scrapy.Spider):
    """
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        ...
        try:
            ...
            strict_flag = False
        spider = super(TribunaJuraSpider, cls).from_crawler(crawler, *args, strict_full=strict_flag, **kwargs)
        try:
        ...
        if response.status == 200 and len(response.body) >= MINIMUM_PAGE_LEN:
            ...
            if self.trefferzahl > 0:
                ...
                if len(werte) < 9:
                    ...
                    # Track detected docids on this page for concise debug
