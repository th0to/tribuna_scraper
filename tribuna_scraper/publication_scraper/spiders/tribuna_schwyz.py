...
class TribunaSchwyzSpider(scrapy.Spider):
    """
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        ...
        try:
            ...
            strict_flag = False
        spider = super(TribunaSchwyzSpider, cls).from_crawler(crawler, *args, strict_full=strict_flag, **kwargs)
        try:
